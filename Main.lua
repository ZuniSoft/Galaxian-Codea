...
function setup()
    ...
    -- controls
    rightBtn = Button(200, 150, asset.documents.Galaxian_assets.Blue_Slider_Right)
    leftBtn = Button(100, 150, asset.documents.Galaxian_assets.Blue_Slider_Left)
    fireBtn = Button(Global.SCREEN_WIDTH - 100,150,asset.documents.Galaxian_assets.Grey_Circle)
end
